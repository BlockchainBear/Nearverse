...
(_dec = NearBindgen({}), _dec(_class = (_class2 = class LandNFT {
  lands = {};
  mintLand({
    owner,
    parcelId,
    ...
    log(`Minted LAND ${parcelId} for ${owner}`);
  }
  getLand({
    parcelId
  }) {
  ...
  transferLand({
    ...
    if (land.owner !== predecessorAccountId()) {
      throw new Error(`Only the current owner can transfer the land.`);
    }
    land.owner = newOwner;
    this.lands[parcelId] = land;
    log(`Transferred LAND ${parcelId} to ${newOwner}`);
  }
}, _applyDecoratedDescriptor(_class2.prototype, "mintLand", [call], Object.getOwnPropertyDescriptor(_class2.prototype, "mintLand"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getLand", [view], Object.getOwnPropertyDescriptor(_class2.prototype, "getLand"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "transferLand", [call], Object.getOwnPropertyDescriptor(_class2.prototype, "transferLand"), _class2.prototype), _class2)) || _class);
