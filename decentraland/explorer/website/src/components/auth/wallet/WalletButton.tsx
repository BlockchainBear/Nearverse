...
import NearLogo from '../../../images/login/wallet-connect.svg'
...
const options = {
  title: {
    ...
    [WalletButtonLogo.NEAR]: 'NEAR Wallet'
  },
  ...
  img: {
    ...
    [WalletButtonLogo.NEAR]: NearLogo
  },
  ...
  target: {
    ...
    [WalletButtonLogo.NEAR]: 'https://wallet.near.org/'
  },
  ...
  provider: {
    ...
    [WalletButtonLogo.NEAR]: ProviderType.WALLET_CONNECT // This will need to be a custom provider
  },
  ...
  description: {
    ...
    [WalletButtonLogo.NEAR]: 'Using your NEAR account'
  }
}
